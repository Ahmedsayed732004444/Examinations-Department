...
class Assessment14Seeder extends Seeder
{
  ...
  'programs_ar' => 'التخطيط الاستراتيجي، إدارة المشروعات، التخطيط المستقبلي، التخطيط المبني على البيانات، الابتكار في حل المشكلات، أساسيات التخطيط وتنظيم الحياة اليومية، بناء عادة التخطيط، إدارة الوقت للمبتدئين، التخطيط الشخصي الفعّال وإدارة الأولويات، التخطيط واتخاذ القرار، التخطيط الاستراتيجي الشخصي',
  'time_limit_min' => 15,
  'is_active' => true,
  'dimensions' =>
  array (
  ...
  array (
    ...
    array (
      ...
      'low_threshold' => 14,
      'high_threshold' => 26,
      'description_ar' => 'تشير نتيجتك إلى أنك تمارس التخطيط في بعض المواقف، إلا أن هذه الممارسة ليست ثابتة أو شاملة في جميع جوانب عملك وحياتك. أنت تمتلك أساسًا جيدًا في التخطيط، لكنك تحتاج إلى تطوير مهاراتك وتحويل التخطيط من ممارسة متقطعة إلى سلوك مهني مستمر.',
    ),
  ),
);
